...
export default function HabitViewScreen() {
  ...
  const { id, occurrenceDate, completionId, activityId } =
  ...
  const { activeIndex, setActiveIndex, effectiveNote, flushPendingChanges } =
    state;
  ...
  const handleEdit = useCallback(() => {
    ...
    if (occurrenceDate) {
      router.push({
        pathname: "/habit/[id]",
        params: { id: habit.id, occurrenceDate },
      });
    } else {
      ...
      <SafeAreaView edges={["top"]} style={styles.content}>
        ...
        >
          <View style={styles.ownerRow}>
            ...
            <FeedCardStats streak={streak} inline />
          </View>
              ...
              <StopwatchPanel
                ...
                occurrenceDate={
                  habit.kind === "scheduled"
                    ? (occurrenceDate ?? isoDate(new Date()))
                    : null
                }
                periodStart={
